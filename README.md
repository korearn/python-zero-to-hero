...
Este repositorio documenta mi aprendizaje estructurado de Python, desde los fundamentos hasta conceptos avanzados y proyectos reales.

## 🎯 Objetivo
Dominar Python aplicando buenas prácticas de ingeniería de software.

## 📚 Estructura del Aprendizaje

### [Módulo 1: Fundamentos Críticos](./01_Fundamentos)
- **Conceptos:** Variables, Tipos de datos, Input/Output, Condicionales, Bucles.
